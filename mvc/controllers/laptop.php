...
class laptop extends controller {
    ...
    public function index(){     
        // Lấy sản phẩm là điện thoại để đổ ra bảng tableProduct
            $cateSame= $this->sameProduct(65);

        //Lấy dữ liệu hãng cho filter
            $brand = $this->CategoryModels->select_array('*',['publish' => 1 , 'parentID' => 64]);
            // echo "<pre>";
            // print_r($brand);die;
    ...
    //  Hàm này dùng để get array id sản phẩm theo key cần lọc đuọc truyền vào
     ...
     public function loadProduct(){
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            // Lấy sp có category giống sp có id 65 => điện thoại
            $cateSame= $this->sameProduct(65);
            ...
            $this->viewFrontEnd('frontend/laptop/loadProduct',$data);
        }
        else{
            $cateSame= $this->sameProduct(65);
