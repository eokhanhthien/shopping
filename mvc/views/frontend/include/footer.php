    ...
    <div class="Container-app">
        <div class="row g-0">
            ...
            <div class="Footer-title">SẢN PHẤM ĐÁNH GIÁ CAO</div>
              <div class="row mt-3">
                <div class="col col-xxl-4">
                    <div class="footer-thumb-product">
                        <img src="mvc/views/frontend/images/dienthoai1.jpg" alt="">
                    </div>
                </div>
                <div class="col col-xxl-8">
                <div class="Footer-content">Điện thoại iPhone 13 Pro Max 128GB</div>
                <div class="Footer-price">34,990,000đ</div>
                </div>
              </div>
          ...
          <div class="col col-xxl-3 col-12" >
            ...
            <div class="Footer-content custom-bb">Nhận hàng và đổi trả </div>
          ...
          <div class="col col-xxl-3 col-12">
            ...
            <div class="Footer-location">Số 201, Phạm Ngũ Lão, Quận 1</div>
            <div class="Footer-location">Số 04, Nguyễn Huệ, Quận 1</div>
          </div>
        </div>


        <div class="custom-bb mt-40 mb-40"></div>
        <div class="Footer-location text-center">Copyright 2021 © Bản quyến thuộc về tập đoàn EO</div> 
    </div>
</div>